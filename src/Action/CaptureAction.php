...
use Waaz\PaylinePlugin\Legacy\SimplePayment;
...
final class CaptureAction implements ActionInterface, ApiAwareInterface
{
     ...
     * @param Payum $payum
     */
    public function __construct(Payum $payum, PaylineBridgeInterface $paylineBridge, UrlGeneratorInterface $router)
    {
        $this->payum = $payum;
    ...
    public function execute($request)
    {
        ...
        $merchantId = $this->paylineBridge->getMerchantId();
